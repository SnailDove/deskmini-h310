...
本人的 **Clover EFI**  : 适配**免驱网卡**的准系统，系统版本（**直接升级**：15.4->15.5->15.6->15.7），备注：Clover EFI的15.6及以后的版本，已经不再维护 2020/10记 。

本人的 **OC EFI** ：适配**免驱网卡**的准系统，系统版本 10.15.x Catalina -> Big Sur 11.0 -> 11.1 -> 11.2.3 -> 11.5.2。
